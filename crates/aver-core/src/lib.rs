...
const MIGRATIONS: &[(&str, &str)] = &[
    ...
    (
        "0043_candidate_created_at_positive_checks",
        include_str!("../../../migrations/0043_candidate_created_at_positive_checks.sql"),
    ),
    (
    ...
    (
        "0046_observation_ts_positive_checks",
        include_str!("../../../migrations/0046_observation_ts_positive_checks.sql"),
    ),
    (
    ...
    (
        "0049_candidate_pending_rejection_exclusion",
        include_str!("../../../migrations/0049_candidate_pending_rejection_exclusion.sql"),
    ),
    (
        "0050_candidate_pending_promotion_exclusion",
        include_str!("../../../migrations/0050_candidate_pending_promotion_exclusion.sql"),
    ),
    (
    ...
    (
        "0053_contradiction_new_claim_distinct_checks",
        include_str!("../../../migrations/0053_contradiction_new_claim_distinct_checks.sql"),
    ),
    (
        "0054_entity_type_name_nonblank_checks",
        include_str!("../../../migrations/0054_entity_type_name_nonblank_checks.sql"),
    ),
    (
    ...
    (
        "0057_predicate_alias_created_at_positive_checks",
        include_str!("../../../migrations/0057_predicate_alias_created_at_positive_checks.sql"),
    ),
    (
        "0058_ontology_extension_predicate_nonblank_checks",
        include_str!("../../../migrations/0058_ontology_extension_predicate_nonblank_checks.sql"),
    ),
    (
        "0059_ontology_extension_parent_nonblank_checks",
        include_str!("../../../migrations/0059_ontology_extension_parent_nonblank_checks.sql"),
    ),
    (
        "0060_ontology_extension_agent_id_nonblank_checks",
        include_str!("../../../migrations/0060_ontology_extension_agent_id_nonblank_checks.sql"),
    ),
    (
        "0061_ontology_extension_agent_id_charset_checks",
        include_str!("../../../migrations/0061_ontology_extension_agent_id_charset_checks.sql"),
    ),
    (
    ...
    (
        "0066_entity_name_nonblank_checks",
        include_str!("../../../migrations/0066_entity_name_nonblank_checks.sql"),
    ),
    (
        "0067_entity_created_at_positive_checks",
        include_str!("../../../migrations/0067_entity_created_at_positive_checks.sql"),
    ),
    (
    ...
    (
        "0074_claim_object_nonblank_checks",
        include_str!("../../../migrations/0074_claim_object_nonblank_checks.sql"),
    ),
    (
        "0075_claim_created_at_positive_checks",
        include_str!("../../../migrations/0075_claim_created_at_positive_checks.sql"),
    ),
    (
        "0076_claim_last_seen_at_positive_checks",
        include_str!("../../../migrations/0076_claim_last_seen_at_positive_checks.sql"),
    ),
];
