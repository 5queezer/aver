...
use aver_extractor::{ExtractedFact, parse_prose_facts};
...
#[test]
fn parse_prose_facts_rejects_empty_predicate() {
    let result =
        parse_prose_facts(r#"{"facts":[{"subject":"User","predicate":"","object":"Rust"}]}"#);
